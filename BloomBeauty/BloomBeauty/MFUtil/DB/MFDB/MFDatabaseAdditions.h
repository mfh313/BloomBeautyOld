...
/** Category of additions for `<MFDatabase>` class.
...
@interface MFDatabase (MFDatabaseAdditions)
...
/** Return `int` value for query
 ...
 @note To use this method from Swift, you must include `MFDatabaseAdditionsVariadic.swift` in your project.
 */
...
/** The schema of the database.
 ...
 @return `MFResultSet` of schema; `nil` on error.
