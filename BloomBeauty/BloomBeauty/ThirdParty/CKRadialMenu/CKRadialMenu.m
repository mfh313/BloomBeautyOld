...
+ (UIView *)createCKRadialMenuBtn:(NSString*)imageName {
    UIImage *image = [UIImage imageNamed:imageName] ;
    UIImageView *imageView = [[UIImageView alloc] initWithImage:image];
    UIView *view = [UIView new];
    view.layer.cornerRadius = imageView.frame.size.width/2;
//    view.backgroundColor = [UIColor redColor];
    view.layer.shadowColor = [[UIColor blackColor] CGColor];
    view.layer.shadowOpacity = 0.6;
    view.layer.shadowRadius = 2.0;
    view.layer.shadowOffset = CGSizeMake(0, 3);
    view.frame = CGRectMake(0, 0, imageView.frame.size.width, imageView.frame.size.height  );
...
- (UIView *) makeDefaultCenterView {
    return [CKRadialMenu createCKRadialMenuBtn:@"retract.png"];
//    UIView *view = [UIView new];
...
//    view.layer.shadowRadius = 2.0;
//    view.layer.shadowOffset = CGSizeMake(0, 3);
//    UIImage *image = [UIImage imageNamed:@"zbl22.png"] ;
//    UIImageView *imageView = [[UIImageView alloc] initWithImage:image];
//    [view addSubview:imageView];
//    return view;
}
...
- (UIView *) makeDefaultPopupView {
    UIView *view = [UIView new];
    view.frame = CGRectMake(0, 0, self.frame.size.width*1.2, self.frame.size.height *1.2 );
    view.layer.cornerRadius = view.frame.size.width/2;
    view.backgroundColor = MFRGB(219,36,131);// [UIColor blueColor];
    view.layer.shadowColor = [[UIColor blackColor] CGColor];
    view.layer.shadowOpacity = 0.6;
